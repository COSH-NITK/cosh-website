  ...
  return (
    <div className="peopleDiv">
      ...
      <div className="peopleSection1Container">
        ...
        <img src={il_people1} className="il_people1" alt="PeopleIllustration1" />
        <img src={il_people2} className="il_people2" alt="PeopleIllustration2" />
      ...
      <div className="peopleSection2Container">
        ...
        <div className={` ${showFilterSidebar ? 'show' : 'peopleFilterSection'}`}>
