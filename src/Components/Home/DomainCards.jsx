                ...
                <div className="domainCard">
                    <div className="domainImg5">
                        <svg id="svg5" width="294" height="294" viewBox="0 0 294 294" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <rect id="box1" x="72" y="129.077" width="37.4273" height="37.4273" fill="#C4C4C4"/>
                            <rect id="box2" x="128.786" y="71" width="37.4273" height="37.4273" fill="#C4C4C4"/>
                            <rect id="box3" x="128.786" y="184.573" width="37.4273" height="37.4273" fill="#C4C4C4"/>
